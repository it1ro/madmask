...
| Главное фото | `srcset`/`sizes` 800w/1200w; миниатюры: `data-thumb-main-url`, `data-thumb-srcset`, aria «Выбрать кадр N» |
| Галерея JS | `product_gallery_controller.js` — подстановка `src`/`srcset` с полноразмерного URL |
